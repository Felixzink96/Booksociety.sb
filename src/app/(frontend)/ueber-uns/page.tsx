...
export const metadata: Metadata = {
  ...
  description:
    "Lerne die Booksociety Saarbruecken kennen: unsere Geschichte, Mission und wie du mitmachen kannst.",
};
...
const faqItems = [
  {
    ...
    answer:
      "Nein, du kannst so oft vorbeikommen wie du moechtest. Es gibt keine Verpflichtung, an jedem Treffen teilzunehmen. Komm einfach, wenn du Lust und Zeit hast!",
  },
  {
    question: "Kostet die Teilnahme etwas?",
    answer:
      "Die Teilnahme ist kostenlos. Wir sind ein ehrenamtlich organisierter Buchclub und freuen uns ueber jede und jeden, die oder der vorbeischaut.",
  },
  {
    question: "Wo trefft ihr euch?",
    answer:
      "An verschiedenen Orten in Saarbruecken – meistens in gemuetlichen Cafes oder oeffentlichen Raeumen. Den genauen Ort findest du immer bei den einzelnen Events.",
  },
  {
    question: "Muss ich das Buch gelesen haben?",
    answer:
      "Beim Lesekreis ist es schoen, wenn du das Buch gelesen hast, aber nicht zwingend noetig. Beim Buechertausch oder Leseabend brauchst du kein bestimmtes Buch gelesen zu haben.",
  },
];
        ...
        <div className="mx-auto max-w-4xl px-6">
          <SectionReveal className="text-center mb-12">
            ...
            <p className="text-charcoal/70 max-w-2xl mx-auto leading-relaxed">
              Wir sind die Booksociety Saarbruecken – ein Buchclub fuer alle, die
              Geschichten lieben.
            </p>
          </SectionReveal>
          ...
          <SectionReveal delay={0.1}>
            <div className="rounded-2xl bg-white p-8 md:p-10 shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Die Booksociety Saarbruecken wurde aus der Ueberzeugung heraus gegruendet,
                dass Lesen mehr ist als eine einsame Beschaeftigung. Was als kleiner
                Lesekreis unter Freunden begann, ist zu einer wachsenden Community
                geworden, die Menschen zusammenbringt – ueber Buecher, Gespraeche und
                gemeinsame Erlebnisse. Wir treffen uns regelmaessig in Saarbruecken, um
                Buecher zu besprechen, zu tauschen und gemeinsam zu lesen.
              </p>
            </div>
          </SectionReveal>
        </div>
        ...
        <div className="mx-auto max-w-4xl px-6">
          <SectionReveal>
            <div className="rounded-2xl bg-white p-8 md:p-10 shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Wir glauben, dass Buecher verbinden. Unsere Mission ist es, einen offenen
                und einladenden Raum zu schaffen, in dem sich Lesebegeisterte
                austauschen koennen – unabhaengig von Alter, Hintergrund oder
          ...
          <SectionReveal>
            <div className="rounded-2xl bg-white p-8 md:p-10 shadow-sm mb-12">
              ...
              <p className="text-charcoal/70 leading-relaxed mb-6">
                Du moechtest dabei sein? Es ist ganz einfach: Schau dir unsere Events
                an und komm vorbei! Du brauchst dich nicht anzumelden – komm einfach
                zum naechsten Treffen und lerne uns kennen. Wir freuen uns auf dich!
              </p>
